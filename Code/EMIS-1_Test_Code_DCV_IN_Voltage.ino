/*
  ...
  Simplified Board Bring Up Test - DCV_IN Voltage Sensor (Output sent to the Serial Print)
  .
  Remember!
...
// **************** INPUTS ****************
#define DCV_IN 36 //GPIO 36/VP (Analog ADC 1 CH0)
...
void loop() {
  ...
  ADC_Constant = 29.80; // Adjust as needed for calibration of DCV_IN.
